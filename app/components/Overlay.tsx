        ...
        <div className="absolute inset-0 w-full h-full pointer-events-none z-10 font-sans">
            ...
            >
                <div className="text-right">
                    ...
                    <p className="text-lg text-white/60 max-w-lg ml-auto leading-relaxed">
                        Proficient in Java, Python, and JavaScript. Specializing in Modern Web, SQL Databases, and Creative Tools like Figma & Photoshop.
                    </p>
                </div>
            </motion.div>
        </div>
